...
class Hero(object):
    ...
    def __crate_images(self):
        self.bomb_list.append(pygame.image.load("./resource/hero_blowup_n1.png"))
        self.bomb_list.append(pygame.image.load("./resource/hero_blowup_n2.png"))
        self.bomb_list.append(pygame.image.load("./resource/hero_blowup_n3.png"))
        self.bomb_list.append(pygame.image.load("./resource/hero_blowup_n4.png"))
